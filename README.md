...
- In-app Help library
- Electron desktop wrap (dev mode)

**Next:**
- **Phase 2 — Production packaging.** electron-builder targets (AppImage / dmg / nsis), asar bundling, Express boot in-process, code signing.
